<x-app-layout>
    ...
    <section class="min-vh-100 pt-2">
        ...
        <section class="pt-5 container">
            ...
            <form action="{{route('episodes.store',$season->id)}}" method="post" data-bs-theme="dark" class="text-light fw-bold"
                ...
                <div class="d-flex gap-3">
                    <div class="">
                        ...
                        <div>
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Ex:Beginig" class="form-control" value="{{old('title')}}"
                    ...
                    <div>
                        <div class="form-group mb-3">
                            ...
                            <input type="number" placeholder="Ex:12" class="form-control" value="{{old('number')}}"
                                name="number" id="number" aria-describedby="number">
                        </div>
                        <div class="mb-3">
                            <label for="episode_link" class="form-label">Episode Video link</label>
                            <input class="form-control" type="text" name="episode_link" placeholder="ex:https://link" id="episode_link">
